...
Please reconnect with Connect-AzAccount using an account/service principal that only have access to one tenant' # $azContextTenants.Count, ($azContextTenants -join ',')
	...
	'Invoke-AzOpsGitPush.AzDevOps.Branch.Switch'							   = '' # 
	'Invoke-AzOpsGitPush.AzDevOps.Commit.Message'							   = '' # $commitMessage
	'Invoke-AzOpsGitPush.AzOps.Change.Invoke'								   = '' # 
	'Invoke-AzOpsGitPush.AzOps.Change.Skipped'								   = '' # 
	'Invoke-AzOpsGitPush.AzOps.Initialize'									   = '' # 
	'Invoke-AzOpsGitPush.Git.Add'											   = '' # 
	'Invoke-AzOpsGitPush.Git.Branch'										   = '' # $headRef
	'Invoke-AzOpsGitPush.Git.Change.Add'									   = '' # 
	'Invoke-AzOpsGitPush.Git.Change.Checkout'								   = '' # $headRef
	'Invoke-AzOpsGitPush.Git.Change.Commit'								       = '' # 
	'Invoke-AzOpsGitPush.Git.Change.Pull'									   = '' # $headRef
	'Invoke-AzOpsGitPush.Git.Change.Push'									   = '' # $headRef
	'Invoke-AzOpsGitPush.Git.Change.Status'								       = '' # 
	'Invoke-AzOpsGitPush.Git.Changes'										   = '' # 
	'Invoke-AzOpsGitPush.Git.Changes.Item'									   = '' # $entry
	'Invoke-AzOpsGitPush.Git.Checkout'										   = '' # main
	'Invoke-AzOpsGitPush.Git.Checkout.Existing'							       = '' # $headRef
	'Invoke-AzOpsGitPush.Git.Checkout.New'									   = '' # $headRef
	'Invoke-AzOpsGitPush.Git.Diff'											   = '' # 
	'Invoke-AzOpsGitPush.Git.Fetch'										       = '' # 
	'Invoke-AzOpsGitPush.Git.IsConsistent'									   = '' # 
	'Invoke-AzOpsGitPush.Git.Pull'											   = '' # main
	'Invoke-AzOpsGitPush.Git.Reset'										       = '' # 
	'Invoke-AzOpsGitPush.Github.Uri'										   = '' # $GithubComment
	'Invoke-AzOpsGitPush.Invalid.Platform'									   = '' # $ScmPlatform
	'Invoke-AzOpsGitPush.Repository.Initialize'							       = '' # 
	'Invoke-AzOpsGitPush.Rest.PR.Comment'									   = '' # 
	'Invoke-AzOpsGitPush.StrictMode'										   = '' # 
