...
@{
    ...
    'AzOpsScope.InitializeMemberVariablesFromFile.LanguageVersion'                  = 'Detected ARM languageVersion {1} in: {0}' # $Path, $resourcePath.languageVersion
    'AzOpsScope.InitializeMemberVariablesFromFile.AssumedCompatibility'             = 'Fallback behavior for unknown ARM languageVersion version {1} in: {0}' # $Path, $resourcePath.languageVersion
    'AzOpsScope.InitializeMemberVariablesFromFile.UnsupportedLanguageVersion'       = 'Detected unsupported ARM languageVersion version {1} in: {0}' # $Path, $resourcePath.languageVersion
    ...
    'Remove-AzOpsDeployment.ResourceDependencyNotFound'                             = 'Missing resource dependency {0} for successfull deletion of {1}. Please add missing resource and retry.'# $resource.Id, $scopeObject.Scope
