...
Set-PSFConfig -Module AzOps -Name Core.AutoGeneratedTemplateFolderPath -Value ".Az" -Initialize -Validation string -Description 'Auto-Genereated Template Folder Path i.e. ./Az'
...
Set-PSFConfig -Module AzOps -Name Core.SkipResourceGroup -Value $false -Initialize -Validation bool -Description '-'
