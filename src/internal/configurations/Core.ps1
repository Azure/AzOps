...
Set-PSFConfig -Module AzOps -Name Core.SkipExtendedChildResourcesDiscovery -Value $true -Initialize -Validation bool -Description 'Global flag to indicate whether Extended Child resources should be discovered or not. Requires SkipResourceGroup and SkipResource to be false.'
